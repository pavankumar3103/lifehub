...
const HomePage = () => {
    ...
    return (
        <>
            ...
            {/* -------- HERO SECTION -------- */}
        <div
            className="min-h-screen bg-cover bg-center flex flex-col items-center justify-center px-6 relative text-white pt-20"
        ...
        >
                ...
                {/* Hero content */}
                <div className="text-center max-w-4xl bg-slate-900/70 backdrop-blur-xl p-10 md:p-12 rounded-3xl relative z-10 border border-teal-500/30 shadow-2xl animate-fade-in">
                {/* Main title */}
                    <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-6 leading-tight animate-slide-up">
                        Centralize Your Life with{' '}
                        <span 
                            className="bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-500 bg-clip-text text-transparent animate-gradient"
                ...
                {/* Subtext */}
                    <p className="text-slate-200 text-xl sm:text-2xl md:text-3xl mb-12 leading-relaxed max-w-3xl mx-auto font-light">
                ...
                {/* Buttons */}
                    ...
                    <button
                            ...
                            className="group bg-gradient-to-r from-teal-500 via-cyan-500 to-teal-600 hover:from-teal-600 hover:via-cyan-600 hover:to-teal-700 text-white font-semibold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-110 shadow-xl hover:shadow-teal-500/50 active:scale-95"
                        ...
                        <button 
                            ...
                            className="border-2 border-teal-400/80 text-teal-300 hover:bg-teal-400/20 hover:border-teal-300 font-semibold py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-110 backdrop-blur-md active:scale-95 text-lg"
                        >
            ...
            >
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Feature 1 */}
                        <div className="group bg-slate-800/70 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-teal-500/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-teal-500/20 hover:border-teal-400/50">
                            <div className="text-5xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">🧘‍♂️</div>
                            <h3 className="text-2xl font-semibold mb-4 text-white group-hover:text-teal-400 transition-colors">Mindful Tracking</h3>
                        ...
                        {/* Feature 2 */}
                        <div className="group bg-slate-800/70 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-teal-500/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-teal-500/20 hover:border-teal-400/50">
                            <div className="text-5xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">🎯</div>
                            <h3 className="text-2xl font-semibold mb-4 text-white group-hover:text-teal-400 transition-colors">Purposeful Goals</h3>
                            <p className="text-slate-300 leading-relaxed text-lg">
                        ...
                        <div className="group bg-slate-800/70 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-teal-500/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-teal-500/20 hover:border-teal-400/50">
                            <div className="text-5xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">🌱</div>
                            <h3 className="text-2xl font-semibold mb-4 text-white group-hover:text-teal-400 transition-colors">Visual Growth</h3>
                            <p className="text-slate-300 leading-relaxed text-lg">
                        ...
                        <div className="group bg-slate-800/70 backdrop-blur-xl rounded-2xl p-8 shadow-xl hover:shadow-teal-500/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-teal-500/20 hover:border-teal-400/50">
                            <div className="text-5xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">🔒</div>
                            <h3 className="text-2xl font-semibold mb-4 text-white group-hover:text-teal-400 transition-colors">Safe Space</h3>
                            <p className="text-slate-300 leading-relaxed text-lg">
            ...
            <section id="dashboard-preview" className="bg-gradient-to-b from-slate-900 to-slate-800 text-white py-24 px-6 text-center relative scroll-mt-20">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="mb-12">
                        ...
                        <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-4">
                            Experience our <strong className="text-teal-400">interactive dashboard</strong> with real-time analytics, personalized insights, and beautiful visualizations.
                        </p>
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                            Track habits, meals, workouts, and mood all in one place with intelligent recommendations and comprehensive analytics.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 border border-teal-500/20 hover:border-teal-400/40 transition-all duration-300 transform hover:scale-105">
                            <div className="text-4xl mb-4">📈</div>
                            <h3 className="text-xl font-semibold mb-2 text-teal-400">Real-Time Analytics</h3>
                            <p className="text-slate-300 text-sm">
                                Interactive charts and graphs showing your progress, trends, and patterns over time.
                            </p>
                        </div>
                        <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 border border-teal-500/20 hover:border-teal-400/40 transition-all duration-300 transform hover:scale-105">
                            <div className="text-4xl mb-4">💡</div>
                            <h3 className="text-xl font-semibold mb-2 text-teal-400">Smart Recommendations</h3>
                            <p className="text-slate-300 text-sm">
                                Personalized suggestions based on your habits and lifestyle patterns.
                            </p>
                        </div>
                        <div className="bg-slate-800/60 backdrop-blur-md rounded-xl p-6 border border-teal-500/20 hover:border-teal-400/40 transition-all duration-300 transform hover:scale-105">
                            <div className="text-4xl mb-4">🎨</div>
                            <h3 className="text-xl font-semibold mb-2 text-teal-400">Beautiful Design</h3>
                            <p className="text-slate-300 text-sm">
                                Modern, responsive interface that works seamlessly on all devices.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-12">
                        <button 
                            ...
                            className="group bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl text-lg"
                            style={{ background: `linear-gradient(135deg, ${colors.primary}, ${colors.accent})` }}
                        >
                            <span className="flex items-center gap-3">
                                Get Started with Interactive Dashboard
